<template>
  <div class="app-container">
    <el-button type="primary"><a href="/static/excel/sample.xlsx" download="活动用户上传模板.xlsx">点击下载模板</a></el-button>
...
export default {
  ...
  data() {
    return {
      tableData: [{ name: '会员名称', period: '期数' }],
      tableHeader: ['name', 'period'],
      commit: false
    }
  },
  methods: {
    ...
    handleUpload() {
      createMember(this.tableData).then(() => {
        this.$notify({
          title: '成功',
          message: '导入成功',
          type: 'success',
