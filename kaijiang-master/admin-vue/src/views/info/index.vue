  ...
  <div class="app-container">
    <el-form ref="infoForm" :model="list" label-width="160px" abel-position="left" style="margin-top: 30px">
      ...
      <el-form-item label="每日范围" class="postInfo-container-item">
        <el-time-picker v-model="list.day_start" placeholder="每日开始时间1" value-format="HH:mm:ss" format="HH:mm:ss" />
      </el-form-item>
      <el-form-item label="" class="postInfo-container-item">
        <el-time-picker v-model="list.day_end" placeholder="每日结束时间1" value-format="HH:mm:ss" format="HH:mm:ss" />
      </el-form-item>
      <el-form-item label="" class="postInfo-container-item">
        <el-time-picker v-model="list.day_start2" placeholder="开始2(选填)" value-format="HH:mm:ss" format="HH:mm:ss" />
      </el-form-item>
      <el-form-item label="" class="postInfo-container-item">
        <el-time-picker v-model="list.day_end2" placeholder="结束2(选填)" value-format="HH:mm:ss" format="HH:mm:ss" />
      </el-form-item>
