...
<!--      </el-select>-->
    ...
    >
      ...
      <el-table-column label="投注号码" align="center" min-width="195px">
        <template slot-scope="scope">
          <span>{{ scope.row.number }}</span>
        </template>
      </el-table-column>
      <el-table-column label="投注期数" align="center" min-width="195px">
        <template slot-scope="scope">
          <span>{{ scope.row.period }}</span>
        </template>
      </el-table-column>
      <el-table-column label="投注时间" align="center" min-width="160px">
        <template slot-scope="scope">
      ...
      <el-table-column label="开奖金额" align="center" min-width="160px">
        <template slot-scope="scope">
          <span v-if="scope.row.status === true">{{ scope.row.bonus }}</span>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item v-if="dialogStatus === 'create'" label="中奖时间" prop="datetime">
          <el-date-picker v-model="temp.create_time" type="datetime" value-format="yyyy-MM-dd HH:mm:ss" placeholder="选择时间" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDownload() {
      ...
      getRecord({ page_size: 500000, isSend: this.listQuery.isSend }).then(response => {
